...
\begin{center}
\includegraphics[width=0.9\linewidth]{Images/steepest_descent.png}
\captionof{figure}{Residual for Steepest descent algorithm}
\end{center}

\begin{center}
\includegraphics[width=0.9\linewidth]{Images/cg_residual.png}
\captionof{figure}{Residual for Conjugate gradient algorithm}
\end{center}
