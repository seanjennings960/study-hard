...
\begin{center}
    ...
    \captionof{figure}{Error across interpolation method and spacing type}
\end{center}

\begin{center}
    \includegraphics[width=0.8\linewidth]{Images/interp_5_linear.png}
    \captionof{figure}{Interpolation with linear spacing N=5}
\end{center}
\begin{center}
    \includegraphics[width=0.8\linewidth]{Images/interp_10_linear.png}
    \captionof{figure}{Interpolation with linear spacing N=10}
\end{center}
\begin{center}
    \includegraphics[width=0.8\linewidth]{Images/interp_15_linear.png}
    \captionof{figure}{Interpolation with linear spacing N=15}
\end{center}
\begin{center}
    \includegraphics[width=0.8\linewidth]{Images/interp_20_linear.png}
    \captionof{figure}{Interpolation with linear spacing N=20}
\end{center}

\section{Problem 3}
\begin{center}
    \includegraphics[width=0.8\linewidth]{Images/interp_5_chebychev.png}
    \captionof{figure}{Interpolation with chebychev spacing N=5}
\end{center}
\begin{center}
    \includegraphics[width=0.8\linewidth]{Images/interp_10_chebychev.png}
    \captionof{figure}{Interpolation with chebychev spacing N=10}
\end{center}
\begin{center}
    \includegraphics[width=0.8\linewidth]{Images/interp_15_chebychev.png}
    \captionof{figure}{Interpolation with chebychev spacing N=15}
\end{center}
\begin{center}
    \includegraphics[width=0.8\linewidth]{Images/interp_20_chebychev.png}
    \captionof{figure}{Interpolation with chebychev spacing N=20}
\end{center}
...
def main():
    ...
    for (chebychev, method), errs in error_norms.items():
        spacing = "(Chebychev)" if chebychev else "(Linear)"
        plt.semilogy(N_list, errs, "o-", label=f"{method} | {spacing}")
    plt.xlabel("N")
