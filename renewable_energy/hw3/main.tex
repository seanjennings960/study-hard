...
$b_s(E)$ is the number of photons with energy in the interval $(E, E + dE)$
that enter a unit area per unit time. $A$ is the area of the cell, and
$q$ is again the charge of an electron.
...
thus reducing the overall power output \cite{nelson_physics_2003}.
...
implemented due to its ease of implementation \cite{eltawil_mppt_2013}.
...
\section{Problem 2}
\begin{letterenum}
\item It is pretty standard for manufacturers
(e.g. \cite{noauthor_tiger_2020}\cite{noauthor_qpeak_2023}) to provide:
\begin{itemize}
...
\item We assume that 80\% ($\rho = 80$) of the graviational potential energy
    ...
    \begin{equation*}
        P = 0.8 (396259 \text{ gal/sec} \cdot 0.00379 \text{ m}^3\text{/gal})
            (9.81 \text{ m/s}^2) (590 \text{ ft} \cdot 0.3048 \text{ m/ft})
            = \boxed{2.120 \text{ MW}}
    \end{equation*}
