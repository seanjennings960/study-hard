fibonacci_sum_squares :: Integer -> Int
fibonacci_sum_squares 0 = 0
fibonacci_sum_squares 1 = 1
fibonacci_sum_squares n = (fn * fn1) `mod` 10
  where
    fn = get_fibonacci_huge n 10
    fn1 = get_fibonacci_huge (n + 1) 10
...
get_fibonacci_huge n m = fib_list !! (fromInteger(n `mod` cycle))
  where
    ...
    cycle = toInteger $ find_cycle_start m
...
main = do
  ...
  print $ fibonacci_sum_squares (read n)
