...
fibonacci_fast n = last (fibonacci_list n)

fibonacci_list :: Int -> [Int]
fibonacci_list 0 = [0]
fibonacci_list 1 = [0, 1]
fibonacci_list n = prev_list ++ [prev_list !! (end-1) + prev_list !! (end - 2)]
    where prev_list = fibonacci_list (n - 1)
          end = length prev_list
